(function() {
  ...
  Interpreter = (function() {
    ...
    Interpreter.prototype.execute = function(instruction) {
      var AssertCount, condition, count, currFace, currList, currentList, face, insertIndex, isReplace, item, list, marker, mouth, nextInstruction, nose, numToReplace, numToRotate, operand1, operand2, pull, put, replaced, tmp, v, x, _i, _j, _k, _len, _len1, _ref, _ref1;
      ...
      switch (mouth) {
        ...
        case '@':
          ...
          for (x = _i = numToRotate; numToRotate <= 1 ? _i <= 1 : _i >= 1; x = numToRotate <= 1 ? ++_i : --_i) {
