...
(function() {
  ...
  MachineError = (function(_super) {
    __extends(MachineError, _super);
  ...
  Value = (function() {
    ...
    Value.prototype.equal = function(other) {
      var _ref, _ref1;
      if (((_ref = this.type) === 'float' || _ref === 'int') && ((_ref1 = other.type) === 'float' || _ref1 === 'int')) {
...
(function() {
  ...
  CodeGenError = (function(_super) {
    __extends(CodeGenError, _super);
  ...
  FunctionDefinition = (function(_super) {
  ...
  IndexedAssignment = (function(_super) {
    __extends(IndexedAssignment, _super);
  ...
  StatementList = (function(_super) {
    __extends(StatementList, _super);
  ...
  Switch = (function(_super) {
    ...
    Switch.prototype.codegen = function(context) {
      var body, case_tuple, condition, default_label, end_label, label, _, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4;
      _ref = this.cases;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        case_tuple = _ref[_i];
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        _ref2 = _ref1[_j], condition = _ref2[0], _ = _ref2[1], label = _ref2[2];
      ...
      for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
        _ref4 = _ref3[_k], _ = _ref4[0], body = _ref4[1], label = _ref4[2];
  ...
  IdentifierExpression = (function(_super) {
  ...
  IndexingExpression = (function(_super) {
    __extends(IndexingExpression, _super);
  ...
  CastExpression = (function(_super) {
  ...
  InfinitaryExpression = (function(_super) {
    __extends(InfinitaryExpression, _super);
  ...
  BinaryExpression = (function(_super) {
  ...
  UnaryExpression = (function(_super) {
  ...
  Parser = (function() {
    ...
    Parser.prototype.parseDeclaration = function() {
      ...
      if (this._nextIs('keyword', 'ITZ')) {
        ...
        if (this._nextIs('keyword', 'A')) {
          this._consume();
          value = DEFAULT_VALUES[this.parseType()];
    ...
    Parser.prototype.parseExpression = function() {
      ...
      if (this._nextIs('keyword')) {
        ...
        } else if (__indexOf.call(UNARY_OPERATORS, keyword) >= 0) {
          return this.parseUnaryExpression();
        } else if (__indexOf.call(BINARY_OPERATORS, keyword) >= 0) {
          return this.parseBinaryExpression();
        } else if (__indexOf.call(INFINITARY_OPERATORS, keyword) >= 0) {
    ...
    Parser.prototype.parseFunctionCall = function() {
      ...
      args = (function() {
        var _i, _ref, _results;
        _results = [];
        for (_ = _i = 0, _ref = this.function_arities[func]; 0 <= _ref ? _i < _ref : _i > _ref; _ = 0 <= _ref ? ++_i : --_i) {
    ...
    Parser.prototype.parseUnaryExpression = function() {
      ...
      if (__indexOf.call(UNARY_OPERATORS, operator) < 0) {
    ...
    Parser.prototype.parseBinaryExpression = function() {
      ...
      operator = this._consume('keyword');
      if (__indexOf.call(BINARY_OPERATORS, operator) < 0) {
    ...
    Parser.prototype.parseInfinitaryExpression = function() {
      var args, operator;
      operator = this._consume('keyword');
      if (__indexOf.call(INFINITARY_OPERATORS, operator) < 0) {
    ...
    Parser.prototype._createStringLiteral = function(str) {
      var buffer, chr, hex, index, parts, variable, _i, _len;
      if (!/^".*"$/.test(str)) {
      ...
      parts = [];
      buffer = [];
      for (index = _i = 0, _len = str.length; _i < _len; index = ++_i) {
        chr = str[index];
        if (chr === ':') {
          chr = str[++index];
          switch (chr) {
...
(function() {
  ...
  TokenizerError = (function(_super) {
